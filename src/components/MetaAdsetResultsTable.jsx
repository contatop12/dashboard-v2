...
const LS_SORT = 'p12_meta_ads_adset_results_sort'
...
function flattenAdsetsFromTree(tree) {
...
export function MetaAdsetResultsTable() {
  ...
  const { page, setPage, pageSize, setPageSize, totalPages, pageRows, total, rangeStart, rangeEnd } =
    usePagedRows(sortedRows, { storageKey: 'p12_pagesize_meta_adsets', defaultSize: PAGE_SIZE })
